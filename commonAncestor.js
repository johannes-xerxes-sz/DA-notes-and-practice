...
Tree.prototype.getClosestCommonAncestor = function(root, a, b) {
  if (!root || root === a || root === b) {
    return root;
  }

  var resultLeft = getClosestCommonAncestor(root.left, a, b),
      resultRight = getClosestCommonAncestor(root.right, a, b);

  return (resultLeft && resultRight) ? root : (resultLeft || resultRight);
